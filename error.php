...
if ($result->num_rows > 0) {
 ...
 sur le panel de police</p>
            <p class="lead text-gray-800 mb-4">Vous devez contacter le commandant pour une affectation.</p>
...
';
  ...
  echo "";
    ...
    echo '          <div class="text-center">
            <p class="lead text-gray-800 mb-4">Vous avez accès au dossier criminel.</p>
